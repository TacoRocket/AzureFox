...
| `principals` | AWS | Planned Azure equivalent | `principals` | `Azure analogue` | Azure principals require Entra/Graph-backed modeling. | Identity graph and trust discovery | Lab planned |
