...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("automation", "resource", collect_automation),
    CommandSpec("devops", "resource", collect_devops),
    ...
    CommandSpec("application-gateway", "network", collect_application_gateway),
